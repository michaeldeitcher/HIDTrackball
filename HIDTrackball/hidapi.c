                                ...
                                uint8_t *report, CFIndex report_length)
{
    ...
    if (dev->input_reports == NULL) {
        ...
        if (rpt->data[0] != 0) {
            dev->mouse_report.buttons = rpt->data[0];
        }
        dev->mouse_report.x += (int8_t)rpt->data[1];
        dev->mouse_report.y += (int8_t)rpt->data[2];
        if ((int8_t)rpt->data[1] != 0 || (int8_t)rpt->data[2] != 0) {
            printf("Mouse X: %i Mouse Y: %i\n", (int8_t)rpt->data[1], (int8_t)rpt->data[2]);
            printf("Total: Mouse X: %i Mouse Y: %i\n", dev->mouse_report.x, dev->mouse_report.y);
        }
